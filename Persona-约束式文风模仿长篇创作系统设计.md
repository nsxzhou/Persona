...
- 单文件故事圣经 (Story Bible) 与动态双向同步 **（已完成）**
- 节拍驱动的结对写作 (Beat-driven Writing) **（已完成）**
- 后台维护角色状态与时间线 **（已完成：已合并至故事圣经）**
- 自动拼装长期上下文 **（已完成）**
...
- Zen Editor 已具备极简编辑器体验、AI 续写与风格挂载、节拍驱动的结对写作（Beat-Driven Co-Creation）、以及动态更新的故事圣经（Story Bible）与差异对比确认机制
