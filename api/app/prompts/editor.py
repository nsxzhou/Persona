...
_BIBLE_UPDATE_SYSTEM = (
    ...
    "## 运行时状态\n"
    "写入会影响后续章节的持续性状态，例如：\n"
    "1. **稳定事实变化** — 身份、位置、持有物、金手指进度、财富/权力扩张等已经稳定改变的信息\n"
    "2. **关系变化** — 角色之间的敌友、信任、情感立场、身体关系突破、控制深度、堕落阶段等\n"
    ...
    "- 准确记录关系进阶的里程碑，包括情感投射的加深、身体关系的突破（如一垒、二垒、本垒打等）、控制深度的增加或堕落阶段的演进\n"
    "- 只记录会持续影响后续选择的关系变化、利益交换，或金手指/系统的升级进度\n"
    "- 不要记录一次性的普通情绪波动，但必须记录能提供“纯粹爽感”、“权力具象化”或“打破禁忌”成果的关键进展\n"
