...
class BaseAnalysisStorageService:
    @property
    ...
    def _build_storage_path(self, sample_file_id: str) -> Path:
        return self._storage_root() / self.sample_dir_name / f"{sample_file_id}.txt"

    def _job_artifact_dir(self, job_id: str) -> Path:
        return self._storage_root() / self.artifact_dir_name / job_id
