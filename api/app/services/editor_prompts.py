...
_SECTION_META: dict[str, dict[str, str]] = {
    "world_building": {
        ...
        "instruction": (
            ...
            "1. 先判断这部作品更接近哪种题材气质，以及灵感是否明确写出超自然；"
            "若灵感未明确写出超自然，则默认不存在超自然\n"
            ...
            "逼他不得不行动\n\n"
            "仅在确有需要时，才补充下列可选模块：\n"
            "- **特殊设定（仅灵感明示时）**：仅当灵感明确出现附身、夺舍、仪式、禁术、异能、"
    ...
    "characters": {
        ...
        "instruction": (
            ...
            "- **金手指/核心优势**：是什么、如何获得、成长路线"
            "（若灵感未涉及金手指，可写核心优势或可利用的筹码）\n"
            "- **角色弧光**：出场状态 → 核心转折 → 最终形态\n"
            "- **反差设计**：至少一个与主要人设反差的特质"
            "（如：冷面无情但对小动物温柔）\n"
...
_CONCEPT_GENERATE_SYSTEM = (
    ...
    "- 概念 1 采用「番茄脑洞/情绪流」：主打极致反转、强爽感、猎奇脑洞、系统或反套路\n"
    "- 概念 2 采用「起点世界/悬念流」：主打宏大世界观、深厚底蕴、长线悬念与稳健升级\n"
    "- 概念 3 采用「反差人设流」：主打独特身份错位、沙雕解构或强烈的反差萌互动\n"
    "- 若需生成更多，自行组合以上策略或引入新切入角度\n\n"
    "## 标题规则\n"
    "- 不超过 15 个汉字，符合现代网文起名规律\n"
    "- 优秀示例：「道诡异仙」「亏成首富从游戏开始」「让你代管宗门，怎么全成大帝了」\n"
    "- 禁止平庸标题如「我的XXX之旅」「关于XXX这件事」\n\n"
    "## 简介规则\n"
    "- 字数精炼（50字左右即可）\n"
    "- 迅速切入核心看点，直给爽点或最大悬念\n"
    "- 必须暗示核心卖点（金手指/脑洞/世界观/人设）\n"
    "- 结尾留悬念或钩子，不揭示结局\n\n"
    "## 输出格式\n"
    ...
    "示例：\n"
    "### 让你代管宗门，怎么全成大帝了\n"
    "师尊飞升前让我代管破落宗门，我只能靠系统瞎忽悠，结果这帮弟子怎么一个个全顿悟成大帝了？\n\n"
