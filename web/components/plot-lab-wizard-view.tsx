...
export function PlotLabWizardView({ jobId }: { jobId: string }) {
  const {
    step,
    setStep,
    form,
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 pb-12">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">{job.plot_name}</h1>
