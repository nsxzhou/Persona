...
export type ProviderChatTestMessage = OpenApiSchema<"ProviderChatTestMessage">;
export type ProviderChatTestRequest = components["schemas"]["ProviderChatTestRequest"];
export type ProviderChatTestResponse = OpenApiSchema<"ProviderChatTestResponse">;
