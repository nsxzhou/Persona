...
- `0012_plot_lab.py`：Plot Lab 核心表（样本文件、分析任务、配置）
- `0013_plot_skeleton_payload.py`：Plot Skeleton 载荷字段
- `0014_analysis_stage_renames.py`：分析阶段重命名
- `0015_gen_profile_payload.py`：项目级生成配置载荷
